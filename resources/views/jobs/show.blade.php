        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <div class="space-y-6">
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <!-- Area Melamar -->
                    @if($hasApplied)
                        <div class="flex flex-col items-center justify-center rounded-xl bg-slate-50 p-4 border border-slate-200 text-center">
                    ...
                    @else
                        ...
                        <a href="{{ route('jobs.apply.create', $job->id) }}" class="w-full rounded-xl bg-indigo-900 py-3.5 text-sm font-bold text-white transition hover:bg-indigo-800 flex items-center justify-center gap-2">
                            <x-lucide-send class="h-4 w-4" /> Ajukan Lamaran
                        </a>
                    @endif
                    <!-- End Area Melamar -->
                </div>

...
<div class=" from-gray-50 to-gray-100 min-h-screen">
    ...
    <div class="flex items-center justify-center py-12 px-4">
        <div class="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600 text-sm">Ayo Semangat Dalam Mencari Kerja</p>
            </div>
            ...
            <form action="{{ route('auth.store') }}" method="POST" class="space-y-4">
                ...
                <!-- Full Name -->
                <div>
                    <label id="nameLabel" class="block text-gray-700 text-sm font-medium mb-2">Nama Lengkap</label>
                    <input
                        id="nameInput"
                        type="text"
                        name="name"
                ...
                <button
                    type="submit"
                    class="w-full bg-primary text-white font-semibold py-3 rounded-md hover:bg-purple-950 transition mt-6">
                    Daftar Sekarang
                </button>
            </form>
            ...
            <p class="text-center text-gray-600 text-sm mt-6">
                Sudah punya akun? <a href="{{ route('auth.login') }}" class="text-primary hover:underline font-bold">Login</a>
            </p>
        </div>
    </div>
    ...
    <script>
        function switchRole(role) {
            ...
            // Update nama label dan placeholder

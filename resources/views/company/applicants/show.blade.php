            ...
            <div class="md:col-span-1 space-y-6">
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <div class="flex items-center justify-between rounded-xl border border-indigo-100 bg-indigo-50 p-4">
                        ...
                        <a href="{{ Storage::url($application->cv_path) }}" target="_blank" class="flex h-10 w-10 items-center justify-center rounded-full bg-white text-indigo-600 shadow-sm transition hover:bg-indigo-600 hover:text-white border border-indigo-200">
